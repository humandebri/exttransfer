...
import type { RelyingPartyOptions } from "@dfinity/oisy-wallet-signer/types/relying-party-options";
import type { RelyingPartyRequestOptions } from "@dfinity/oisy-wallet-signer/types/relying-party-requests";
